...
public class OapiProcessinstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2691112221245387873L;
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 3121368735847111236L;
		/**
		 * 组件类型
		 */
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6569522546542691328L;
		/**
		 * 审批人列表
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 4849728836832929983L;
		/**
		 * list
		 */
		@ApiListField("list")
