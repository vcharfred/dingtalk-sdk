...
public class OapiDingpayOrderTerminateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4211936855293238214L;
	...
	public static class OrderTerminateResultItem extends TaobaoObject {
		private static final long serialVersionUID = 7798882995998795649L;
		/**
		 * 订单号
		 */
		@ApiField("order_no")
	...
	public static class OrderTerminationOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 8163737686359246876L;
		/**
		 * 终止结果列表
		 */
