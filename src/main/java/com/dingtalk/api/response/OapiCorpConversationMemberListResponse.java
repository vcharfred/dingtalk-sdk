...
public class OapiCorpConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8328845597136215467L;
	...
	public static class OpenMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 8711892443436822448L;
		/**
		 * 员工ID
		 */
		@ApiField("userid")
	...
	public static class OpenMemberListModel extends TaobaoObject {
		private static final long serialVersionUID = 8388859142419594163L;
		/**
		 * 成员信息
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 4376641866934921693L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
