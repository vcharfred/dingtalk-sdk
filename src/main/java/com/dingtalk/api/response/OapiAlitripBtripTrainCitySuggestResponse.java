...
public class OapiAlitripBtripTrainCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2664982216315818724L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 4498256382599843245L;
		/**
		 * 城市码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 8583117265878996872L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
