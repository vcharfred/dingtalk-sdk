...
public class OapiAlitripBtripApplySearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7586433449181675513L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 5484827298979816329L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 2572997571695532847L;
		/**
		 * 用户名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 7312544769293944979L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 7899447334962245278L;
		/**
		 * 商旅审批展示id
		 */
