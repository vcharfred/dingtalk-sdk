...
public class OapiAttendanceGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7198643116299386237L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7891713238354348512L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 7156811171356152429L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 5463569664752743831L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 6897842177545387672L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4413533331154545825L;
		/**
		 * 考勤组中的班次列表
		 */
