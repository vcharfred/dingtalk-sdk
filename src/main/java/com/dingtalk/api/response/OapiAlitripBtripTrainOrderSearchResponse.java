...
public class OapiAlitripBtripTrainOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4863787489217384646L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 4473294967934817516L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 6857678826731435111L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 4866493873938266964L;
		/**
		 * 消费类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 1225578725377424152L;
		/**
		 * 乘车人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenTrainOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 8184634999856366394L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
