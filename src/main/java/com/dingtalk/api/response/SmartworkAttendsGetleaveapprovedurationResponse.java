...
public class SmartworkAttendsGetleaveapprovedurationResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3449562151386648662L;
	...
	public static class ApproveDurationForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3621545671638859561L;
		/**
		 * 请假时长（单位分钟）
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 7137958173165848176L;
		/**
		 * dingOpenErrcode
		 */
