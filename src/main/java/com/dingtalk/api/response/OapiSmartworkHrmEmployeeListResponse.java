...
public class OapiSmartworkHrmEmployeeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8155222657885774138L;
	...
	public static class EmpFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 5552819369476413585L;
		/**
		 * 字段编码
		 */
		@ApiField("field_code")
	...
	public static class EmpFieldInfoVO extends TaobaoObject {
		private static final long serialVersionUID = 2648675486653825516L;
		/**
		 * 字段信息列表
		 */
