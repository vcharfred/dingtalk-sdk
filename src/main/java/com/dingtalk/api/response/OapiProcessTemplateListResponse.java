...
public class OapiProcessTemplateListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4789954638167972458L;
	...
	public static class Templatelist extends TaobaoObject {
		private static final long serialVersionUID = 7767636948244643184L;
		/**
		 * 是否可升级，加入收款账户组件
		 */
	...
	public static class CorpTemplateVo extends TaobaoObject {
		private static final long serialVersionUID = 4796196483154852668L;
		/**
		 * 下次调用时的offset入参
		 */
