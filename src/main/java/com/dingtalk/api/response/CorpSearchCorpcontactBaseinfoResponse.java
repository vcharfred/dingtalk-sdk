...
public class CorpSearchCorpcontactBaseinfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8811927379728613239L;
	...
	public static class GroupContactResult extends TaobaoObject {
		private static final long serialVersionUID = 6538165345269572192L;
		/**
		 * aliTmpDept
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 4768759522747517676L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3626448724899542613L;
		/**
		 * dingOpenErrcode
		 */
