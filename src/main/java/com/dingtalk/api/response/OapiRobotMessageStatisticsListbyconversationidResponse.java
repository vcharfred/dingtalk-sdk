...
public class OapiRobotMessageStatisticsListbyconversationidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2142944966135764864L;
	...
	public static class MsgStatByCIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 1319222939684826538L;
		/**
		 * 群Id
		 */
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 2167738135991216833L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6762741683547986792L;
		/**
		 * list
		 */
		@ApiListField("list")
