...
public class OapiSmartworkHrmEmployeeListdimissionResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3224631618695811192L;
	...
	public static class EmpDeptVO extends TaobaoObject {
		private static final long serialVersionUID = 2162427787557246327L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class EmpDimissionInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 8813742623626674117L;
		/**
		 * 离职部门列表
		 */
