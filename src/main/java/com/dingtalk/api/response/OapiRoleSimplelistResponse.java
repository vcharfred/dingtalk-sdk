...
public class OapiRoleSimplelistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5467133465398689225L;
	...
	public static class OrgDeptVo extends TaobaoObject {
		private static final long serialVersionUID = 8797778194921272153L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class OpenEmpSimple extends TaobaoObject {
		private static final long serialVersionUID = 4271721175336912917L;
		/**
		 * 管理范围
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 2536777434852586193L;
		/**
		 * 后面是否还有数据
		 */
		@ApiField("hasMore")
