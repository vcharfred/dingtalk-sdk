...
public class OapiSmartworkHrmEmployeeListcontactResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1462944976124258979L;
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 5436313767126379496L;
		/**
		 * 字段编码
		 */
		@ApiField("field_code")
	...
	public static class EmpFieldInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 1885977721697234466L;
		/**
		 * 字段信息列表
		 */
