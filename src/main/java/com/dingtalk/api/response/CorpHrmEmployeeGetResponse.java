...
public class CorpHrmEmployeeGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7886996123571564499L;
	...
	public static class SysCustomFieldVpo extends TaobaoObject {
		private static final long serialVersionUID = 8519832237374599871L;
		/**
		 * 确认入职是否必填
		 */
	...
	public static class FieldGroupVpo extends TaobaoObject {
		private static final long serialVersionUID = 7477779294329582469L;
		/**
		 * 字段列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3225576428982479575L;
		/**
		 * dingOpenErrcode
		 */
