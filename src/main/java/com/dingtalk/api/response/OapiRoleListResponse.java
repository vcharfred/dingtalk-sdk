...
public class OapiRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2878523856649592631L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 6553556487824652979L;
		/**
		 * 角色id
		 */
		@ApiField("id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 3576398245522311315L;
		/**
		 * 角色组id
		 */
		@ApiField("groupId")
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 4569867949692391449L;
		/**
		 * hasMore
		 */
		@ApiField("hasMore")
