...
public class OapiImpaasGroupQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5222954453311498298L;
	...
	public static class BaseGroupMemberInfo extends TaobaoObject {
		private static final long serialVersionUID = 8825569861986428366L;
		/**
		 * 群主ID，类型由type字段决定
		 */
		@ApiField("id")
	...
	public static class GroupInfo extends TaobaoObject {
		private static final long serialVersionUID = 1682787292498192577L;
		/**
		 * 群ID
		 */
		@ApiField("chatid")
