...
public class OapiAppstoreInternalUnfinishedorderListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4156382673793853973L;
	...
	public static class InAppGoodsOrderVO extends TaobaoObject {
		private static final long serialVersionUID = 5254869548112856243L;
		/**
		 * 订单号
		 */
	...
	public static class PageModel extends TaobaoObject {
		private static final long serialVersionUID = 8315194246712858689L;
		/**
		 * 订单信息列表
		 */
		@ApiListField("items")
