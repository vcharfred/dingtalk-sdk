...
public class OapiServiceaccountMenuGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5372691394187828652L;
	...
	public static class MenuSubButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 6878331411435673127L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 4857773913813678682L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuConfigDTO extends TaobaoObject {
		private static final long serialVersionUID = 2528961979571349193L;
		/**
		 * 菜单按钮列表
		 */
		@ApiListField("button")
