...
public class OapiAttendanceClassGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8673473481917681132L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8568369453935743475L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class AtClassSettingForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5198377626353613756L;
		/**
		 * classId
		 */
		@ApiField("class_id")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 2745137538579611366L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2842336524825715133L;
		/**
		 * 考勤组班次配置
		 */
