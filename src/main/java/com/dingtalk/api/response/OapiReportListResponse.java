...
public class OapiReportListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6284778782418521677L;
	...
	public static class JsonObject extends TaobaoObject {
		private static final long serialVersionUID = 7552416775232871794L;
		/**
		 * 模板内容
		 */
		@ApiField("key")
	...
	public static class ReportOapiVo extends TaobaoObject {
		private static final long serialVersionUID = 3532951378673868799L;
		/**
		 * 日志内容
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 5152555382895424463L;
		/**
		 * 日志列表
		 */
