...
public class OapiAttendanceGroupPositionsAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8457442852143123341L;
	...
	public static class Position extends TaobaoObject {
		private static final long serialVersionUID = 5812537495521631696L;
		/**
		 * 地址描述
		 */
		@ApiField("address")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 8278168968254635749L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 6617117746513925319L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3592245945425735836L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
