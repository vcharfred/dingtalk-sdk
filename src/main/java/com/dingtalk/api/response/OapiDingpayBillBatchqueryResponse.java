...
public class OapiDingpayBillBatchqueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4865433623861963122L;
	...
	public static class DingPayBillOpenBo extends TaobaoObject {
		private static final long serialVersionUID = 8194159419769671296L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class BillBatchQueryOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 6786789647549552927L;
		/**
		 * billList
		 */
