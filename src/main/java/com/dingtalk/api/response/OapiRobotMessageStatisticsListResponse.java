...
public class OapiRobotMessageStatisticsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8638246852142674348L;
	...
	public static class MsgStatResVo extends TaobaoObject {
		private static final long serialVersionUID = 1342153674212772598L;
		/**
		 * 机器人消息推送Id
		 */
		@ApiField("push_id")
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 3345547111843879992L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 8331664786438694635L;
		/**
		 * list
		 */
		@ApiListField("list")
