...
public class OapiAttendanceGroupWifisAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2347855541999122874L;
	...
	public static class Wifi extends TaobaoObject {
		private static final long serialVersionUID = 5189294796595956584L;
		/**
		 * 业务方wifiId
		 */
		@ApiField("foreign_id")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 8153449879489275231L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 8468766426321622383L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1559489371534248299L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
