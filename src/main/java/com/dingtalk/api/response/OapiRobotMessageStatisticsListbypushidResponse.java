...
public class OapiRobotMessageStatisticsListbypushidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4753717673817872295L;
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 6227384786494737616L;
		/**
		 * 当前页数
		 */
	...
	public static class MsgStatByPushIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 5643638853826791278L;
		/**
		 * 群Id
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6683537321122879874L;
		/**
		 * list
		 */
		@ApiListField("list")
