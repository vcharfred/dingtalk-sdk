...
public class OapiAlitripBtripApplyGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1458147271359311126L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 3524931117777211745L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 7264859951886576947L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 2573916912587422136L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 3198178227475358726L;
		/**
		 * 商旅审批展示id
		 */
