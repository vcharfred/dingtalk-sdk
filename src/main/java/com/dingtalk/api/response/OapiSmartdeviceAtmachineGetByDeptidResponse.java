...
public class OapiSmartdeviceAtmachineGetByDeptidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4243386295521772972L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 7113684434816543496L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 4857841919511578637L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
