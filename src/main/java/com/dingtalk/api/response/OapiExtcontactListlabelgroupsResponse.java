...
public class OapiExtcontactListlabelgroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7426689678642618255L;
	...
	public static class OpenLabel extends TaobaoObject {
		private static final long serialVersionUID = 5772924163942979581L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenLabelGroup extends TaobaoObject {
		private static final long serialVersionUID = 8617942961378713859L;
		/**
		 * 标签组颜色
		 */
		@ApiField("color")
