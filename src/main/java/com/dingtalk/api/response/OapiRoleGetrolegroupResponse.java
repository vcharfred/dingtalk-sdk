...
public class OapiRoleGetrolegroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8494597379768456459L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 8784325351984176268L;
		/**
		 * 角色id
		 */
		@ApiField("role_id")
	...
	public static class OpenRoleGroup extends TaobaoObject {
		private static final long serialVersionUID = 4758285483455128777L;
		/**
		 * 角色组名
		 */
		@ApiField("group_name")
