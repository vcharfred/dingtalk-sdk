...
public class OapiAttendanceGetleavetimebynamesResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8317553345454116978L;
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2334684535278145591L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 2372768143775472168L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8762571598937819328L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5546129941583691486L;
		/**
		 * 列信息与列值数据
		 */
