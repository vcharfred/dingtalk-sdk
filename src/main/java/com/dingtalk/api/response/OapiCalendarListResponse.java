...
public class OapiCalendarListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5839364181247526285L;
	...
	public static class Attendees extends TaobaoObject {
		private static final long serialVersionUID = 6629352458792983793L;
		/**
		 * 展示姓名
		 */
	...
	public static class User extends TaobaoObject {
		private static final long serialVersionUID = 8425327178493164736L;
		/**
		 * 展示姓名
		 */
		@ApiField("display_name")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 1677396518537354533L;
		/**
	...
	public static class Items extends TaobaoObject {
		private static final long serialVersionUID = 6382317973145492958L;
		/**
		 * 参与者
		 */
	...
	public static class OpenCalendarListResponse extends TaobaoObject {
		private static final long serialVersionUID = 2368495263236488266L;
		/**
		 * 日程的实体
		 */
		@ApiListField("items")
