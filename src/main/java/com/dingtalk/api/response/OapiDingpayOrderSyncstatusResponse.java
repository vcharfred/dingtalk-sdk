...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8884892826294697677L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 6169249456431244181L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 8637243539893455554L;
		/**
		 * orders
		 */
		@ApiListField("orders")
