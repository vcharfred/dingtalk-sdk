...
public class OapiAlitripBtripFlightOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4595787498875668573L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 3482679521591916242L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 5556489623966221266L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 6718692361261663686L;
		/**
		 * 交易类目
		 */
		@ApiField("category")
	...
	public static class OpenFlightInsureInfo extends TaobaoObject {
		private static final long serialVersionUID = 2571564828549491946L;
		/**
		 * 保单号
		 */
		@ApiField("insure_no")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 1323548918921281487L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenFlightOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 4856935193946566244L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
