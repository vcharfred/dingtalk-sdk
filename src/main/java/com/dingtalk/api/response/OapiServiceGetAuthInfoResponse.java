...
public class OapiServiceGetAuthInfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1691358374588283312L;
	...
	public static class Agent extends TaobaoObject {
		private static final long serialVersionUID = 7488368944431959827L;
		/**
		 * admin_list
		 */
	...
	public static class AuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 6281133472834297865L;
		/**
		 * agent
		 */
		@ApiListField("agent")
	...
	public static class AuthUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 6144363231583714717L;
		/**
		 * userId
		 */
		@ApiField("userId")
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 7186311948398793586L;
		/**
		 * auth_channel
		 */
	...
	public static class Channelagent extends TaobaoObject {
		private static final long serialVersionUID = 4192276728346286628L;
		/**
		 * agent_name
		 */
		@ApiField("agent_name")
	...
	public static class ChannelAuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 4147732814534878392L;
		/**
		 * channelAgent
		 */
