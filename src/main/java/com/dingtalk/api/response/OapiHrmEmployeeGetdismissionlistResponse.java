...
public class OapiHrmEmployeeGetdismissionlistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8129264324858676974L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 2848951785288195721L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 1361997898715891856L;
		/**
		 * 当前页
		 */
		@ApiField("current")
