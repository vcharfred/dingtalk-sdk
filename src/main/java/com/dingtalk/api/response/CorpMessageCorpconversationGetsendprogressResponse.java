...
public class CorpMessageCorpconversationGetsendprogressResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1592737933234417891L;
	...
	public static class AsyncSendProgress extends TaobaoObject {
		private static final long serialVersionUID = 5187795527879856635L;
		/**
		 * 取值 0-100，表示处理的百分比
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 4819626329932442462L;
		/**
		 * dingOpenErrcode
		 */
