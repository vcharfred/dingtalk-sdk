...
public class OapiImChatServicegroupMemberQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5187989872829186447L;
	...
	public static class Members extends TaobaoObject {
		private static final long serialVersionUID = 3159237713377488964L;
		/**
		 * 成员的ID
		 */
	...
	public static class ServiceGroupMemberQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 5795645398459841476L;
		/**
		 * 成员列表
		 */
