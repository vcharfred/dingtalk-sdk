...
public class OapiAttendanceVacationQuotaUpdateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4194283537796649584L;
	...
	public static class Quota extends TaobaoObject {
		private static final long serialVersionUID = 6179123866217747298L;
		/**
		 * 假期类型唯一标识
		 */
		@ApiField("leave_code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7252633888263882451L;
		/**
		 * 失败记录
		 */
		@ApiField("quota")
