...
public class SmartworkBpmsProcessinstanceidListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8883419121389796792L;
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4518548543399157853L;
		/**
		 * 审批实例id
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 2712618232489187312L;
		/**
		 * list
		 */
		@ApiListField("list")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3895477634435436855L;
		/**
		 * 错误码
		 */
