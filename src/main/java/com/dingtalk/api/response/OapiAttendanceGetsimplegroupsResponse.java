...
public class OapiAttendanceGetsimplegroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7113798181531883823L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 3389882431972118567L;
		/**
		 * 开始时间
		 */
		@ApiField("check_time")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7332819896261972848L;
		/**
		 * 旷工迟到时长,单位分钟
		 */
	...
	public static class SetionTimeVO extends TaobaoObject {
		private static final long serialVersionUID = 3452156853957949981L;
		/**
		 * 打卡时间跨度
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 7864838877654862526L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 1727631371774544247L;
		/**
		 * 考勤班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8272387123437987563L;
		/**
	...
	public static class AtGroupListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5439612851646885728L;
		/**
		 * 考勤组列表
		 */
		@ApiListField("groups")
