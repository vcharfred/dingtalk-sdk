...
public class CorpDingReceiverstatusListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8575566351595797524L;
	...
	public static class DingReceiverStatusResult extends TaobaoObject {
		private static final long serialVersionUID = 7837268869582757129L;
		/**
		 * 确认状态。0-未确认；1-已确认；
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3329967337654641188L;
		/**
		 * 错误码
		 */
