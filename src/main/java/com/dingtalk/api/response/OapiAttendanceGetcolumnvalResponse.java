...
public class OapiAttendanceGetcolumnvalResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5559533254779748414L;
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 4698322853176965256L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6522762547667567684L;
		/**
		 * 列id
		 */
		@ApiField("id")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6829866756753914252L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1352675176677383862L;
		/**
		 * 列信息与列值数据
		 */
		@ApiListField("column_vals")
