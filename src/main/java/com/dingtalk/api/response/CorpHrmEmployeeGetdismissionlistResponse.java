...
public class CorpHrmEmployeeGetdismissionlistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2776465948152678322L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 3673828444743935211L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 8295851295742479829L;
		/**
		 * 当前页
		 */
		@ApiField("current")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1438328937686245686L;
		/**
		 * 错误码
		 */
