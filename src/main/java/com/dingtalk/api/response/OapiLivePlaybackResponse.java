...
public class OapiLivePlaybackResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1147844978137711825L;
	...
	public static class PlayBackModel extends TaobaoObject {
		private static final long serialVersionUID = 2743415925744895521L;
		/**
		 * 封面图
		 */
		@ApiField("cover_url")
	...
	public static class PlayBackRespModel extends TaobaoObject {
		private static final long serialVersionUID = 2649341256496721311L;
		/**
		 * 结果总数
		 */
		@ApiField("all_count")
