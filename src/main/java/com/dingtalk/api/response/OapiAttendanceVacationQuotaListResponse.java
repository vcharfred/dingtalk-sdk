...
public class OapiAttendanceVacationQuotaListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5746219331287337119L;
	...
	public static class Leavequotas extends TaobaoObject {
		private static final long serialVersionUID = 2671454964617647181L;
		/**
		 * 额度有效期结束时间(毫秒级时间戳)
		 */
		@ApiField("end_time")
	...
	public static class OapiLeaveQuotaUserListVo extends TaobaoObject {
		private static final long serialVersionUID = 2768289286779142112L;
		/**
		 * 是否存在更多记录
		 */
		@ApiField("has_more")
