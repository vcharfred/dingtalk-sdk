...
public class OapiWorkbenchShortcutListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2849691652459991691L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 6813259176284265144L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 6585954475443733481L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
