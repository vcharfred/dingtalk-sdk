...
public class OapiAttendanceGetupdatedataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4455251528199933638L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 1133143632912476744L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4665442789624445899L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7338676478694366752L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtRestTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 1153787365999189876L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassSettingInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 1642738788845361121L;
		/**
		 * restTimeVOList
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 1885512991991383834L;
		/**
		 * 审批单列表
		 */
