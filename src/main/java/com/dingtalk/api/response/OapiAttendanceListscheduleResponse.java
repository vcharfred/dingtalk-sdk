...
public class OapiAttendanceListscheduleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7859652184899538767L;
	...
	public static class AtScheduleForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8718594289145818346L;
		/**
	...
	public static class AtScheduleListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 4561829889696921243L;
		/**
		 * 分页用，表示是否还有下一页
		 */
		@ApiField("has_more")
