...
public class CorpRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6343372179786282333L;
	...
	public static class Roles extends TaobaoObject {
		private static final long serialVersionUID = 7681469191595359877L;
		/**
		 * 角色ID
		 */
		@ApiField("id")
	...
	public static class RoleGroups extends TaobaoObject {
		private static final long serialVersionUID = 7441184897636573243L;
		/**
		 * 角色分组名称
		 */
		@ApiField("group_name")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 8716979488441763625L;
		/**
		 * 分页是否还有数据
		 */
		@ApiField("has_more")
