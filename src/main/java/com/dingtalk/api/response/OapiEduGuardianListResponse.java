...
public class OapiEduGuardianListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6595927556611312283L;
	...
	public static class GuardianRespone extends TaobaoObject {
		private static final long serialVersionUID = 1392557323312937667L;
		/**
		 * 家长ID
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6195294143833261978L;
		/**
		 * 是否存在下一页
		 */
		@ApiField("has_more")
