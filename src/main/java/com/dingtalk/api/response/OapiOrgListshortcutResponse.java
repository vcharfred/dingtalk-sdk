...
public class OapiOrgListshortcutResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1151447822992915347L;
	...
	public static class OrgShortcutVO extends TaobaoObject {
		private static final long serialVersionUID = 1734492721436873766L;
		/**
		 * 类型，1表示工作台微应用
		 */
		@ApiField("type")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 4361594153595272735L;
		/**
		 * dingOpenErrcode
		 */
		@ApiField("errcode")
