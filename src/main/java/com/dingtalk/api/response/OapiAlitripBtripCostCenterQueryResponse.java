...
public class OapiAlitripBtripCostCenterQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1313692873424482621L;
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 3661987824617218756L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenCostCenterQueryRs extends TaobaoObject {
		private static final long serialVersionUID = 5619844198543664639L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
