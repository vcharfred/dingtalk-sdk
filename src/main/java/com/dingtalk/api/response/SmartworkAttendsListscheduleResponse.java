...
public class SmartworkAttendsListscheduleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6288975513724262867L;
	...
	public static class AtScheduleForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5745931866955561269L;
		/**
	...
	public static class AtScheduleListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8769321737577834768L;
		/**
		 * 分页用，表示是否还有下一页
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 6625525666771143248L;
		/**
		 * dingOpenErrcode
		 */
