...
import com.dingtalk.api.response.OapiAttendanceGroupDeleteResponse;
...
public class OapiAttendanceGroupDeleteRequest extends BaseTaobaoRequest<OapiAttendanceGroupDeleteResponse> {
	...
	* 操作人userId
	...
	public Class<OapiAttendanceGroupDeleteResponse> getResponseClass() {
		return OapiAttendanceGroupDeleteResponse.class;
	}
