...
import com.dingtalk.api.response.OapiConferenceParticipantDeleteResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.conference.participant.delete request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.03
 */
public class OapiConferenceParticipantDeleteRequest extends BaseTaobaoRequest<OapiConferenceParticipantDeleteResponse> {
	...
	* 操作用户id
	...
	public Class<OapiConferenceParticipantDeleteResponse> getResponseClass() {
		return OapiConferenceParticipantDeleteResponse.class;
	}
