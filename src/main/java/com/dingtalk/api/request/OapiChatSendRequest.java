...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 2286733323457724688L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 7738374755147332342L;
		/**
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 5189563387229172641L;
		/**
		 * 消息头部背景颜色
		 */
		@ApiField("bgcolor")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 5634578459998866188L;
		/**
		 * 单行富文本信息的单位
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 3574719178367218548L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 1371614729365943886L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 4134784816664735162L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 3521898197671627286L;
		/**
		 * 语音mediaId
		 */
		@ApiField("media_id")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 3762298736337799998L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 7732364772621258296L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6223897328285728129L;
		/**
		 * messageUrl
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 3147122661611584177L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 8883968239375876182L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 7462162695481626926L;
		/**
		 * action_url
		 */
		@ApiField("action_url")
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 5143796387655798887L;
		/**
		 * action_card
		 */
