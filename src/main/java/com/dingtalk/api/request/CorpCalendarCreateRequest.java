...
public class CorpCalendarCreateRequest extends BaseTaobaoRequest<CorpCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 2876388769962928352L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 1765671589464463989L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 7116475823585317131L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 8331746688234814567L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
