...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.group.users.remove request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.01
 */
public class OapiAttendanceGroupUsersRemoveRequest extends BaseTaobaoRequest<OapiAttendanceGroupUsersRemoveResponse> {
	...
	* 用户列表
	...
	public Class<OapiAttendanceGroupUsersRemoveResponse> getResponseClass() {
		return OapiAttendanceGroupUsersRemoveResponse.class;
	}
