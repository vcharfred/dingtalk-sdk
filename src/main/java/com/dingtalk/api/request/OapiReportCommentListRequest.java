...
/**
 * TOP DingTalk-API: dingtalk.oapi.report.comment.list request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.01
 */
public class OapiReportCommentListRequest extends BaseTaobaoRequest<OapiReportCommentListResponse> {
	...
	* 分页参数，每页大小，最多传20，默认值为20
	...
	public Class<OapiReportCommentListResponse> getResponseClass() {
		return OapiReportCommentListResponse.class;
	}
