...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.group.users.query request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.01
 */
public class OapiAttendanceGroupUsersQueryRequest extends BaseTaobaoRequest<OapiAttendanceGroupUsersQueryResponse> {
	...
	* 分页大小
	...
	public Class<OapiAttendanceGroupUsersQueryResponse> getResponseClass() {
		return OapiAttendanceGroupUsersQueryResponse.class;
	}
